...
def generate_fake_course_data(num_programs: int, num_Subjects: int, num_course_allocations: int, num_uploads: int, num_upload_videos: int, num_course_offers: int) -> None:
    """Generate fake data using various factories.

    Args:
        num_programs (int): Number of fake programs to create.
        num_Subjects (int): Number of fake Subjects to create.
    ...
    Subjects = CourseFactory.create_batch(num_Subjects)
